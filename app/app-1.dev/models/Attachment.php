 ...
 * @method Attachment findBySql() findBySql(string $sql, array $params = array())
 * @method Attachment[] findAllBySql() findAllBySql(string $sql, array $params = array())
 *
 *
 * @method unsetFilters() unsetFilters()
 ...
 * @method setRelationRecords() setRelationRecords($relation, $data, $merge)
 * @method addSaveRelation() addSaveRelation($relation, $message)
 * @method removeSaveRelation() removeSaveRelation($relation)
 * @method setRelationScenario() setRelationScenario($relation, $scenario)
 * @method setSaveRelationMessage() setSaveRelationMessage($relation, $message)
 *
 *
 * @property integer $id
