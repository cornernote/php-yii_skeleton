 ...
 *
 */
$this->pageTitle = t('Privacy Policy');
$this->pageHeading = t('Privacy Policy');
?>

This Privacy Policy governs the manner in which Key Terminal collects, uses, maintains and discloses information collected from users (each, a "User") of the <a href="www.keyterminal.com">www.keyterminal.com</a> website ("Site"). This privacy policy applies to the Site and all products and services offered by Key Terminal.<br><br>
...
Key Terminal may collect and use Users personal information for the following purposes:<br>
<ul>
