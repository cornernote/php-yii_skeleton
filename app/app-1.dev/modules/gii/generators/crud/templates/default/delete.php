...
echo "\$this->pageTitle = \$this->pageHeading = \$this->getName() . ' ' . t('Delete');\n";
...
echo "\$this->breadcrumbs[] = t('Delete');\n";
echo "\n";
...
echo "    'id' => '" . lcfirst($this->modelClass) . "-delete-form',\n";
echo "    'type' => 'horizontal',\n";
echo "    'action' => array('/" . lcfirst($this->modelClass) . "/delete', 'id' => \$id),\n";
echo "));\n";
echo "echo sfGridHidden(\$id);\n";
echo "echo CHtml::hiddenField('confirm', 1);\n";
