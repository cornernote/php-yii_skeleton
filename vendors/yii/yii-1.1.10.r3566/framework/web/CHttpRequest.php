...
class CHttpRequest extends CApplicationComponent
{
	...
	protected function decodePathInfo($pathInfo)
	{
        ...
        /**
         * can not encode strings over 307 characters or we get webpage not available
         * reason unknown, not researched
         * @author brett@mrphp.com.au
         */
        if (strlen($pathInfo)>300) {
            return $pathInfo;
        }
